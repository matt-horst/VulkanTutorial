...
class HelloTriangleApplication {
 ...
 private:
  ...
  void createTextureImage() {
    ...
    createImage(
        static_cast<uint32_t>(texWidth), static_cast<int32_t>(texHeight), mipLevels, vk::SampleCountFlagBits::e1,
        vk::Format::eR8G8B8A8Srgb, vk::ImageTiling::eOptimal,
        vk::ImageUsageFlagBits::eSampled | vk::ImageUsageFlagBits::eTransferDst |
        vk::ImageUsageFlagBits::eTransferSrc, vk::MemoryPropertyFlagBits::eDeviceLocal, textureImage,
        textureImageMemory);
    ...
    generateMipMaps(textureImage, vk::Format::eR8G8B8A8Srgb, static_cast<int32_t>(texWidth),
                    static_cast<int32_t>(texHeight), mipLevels);
  }
